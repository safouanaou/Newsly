const HomePage = {
    template: `
        <main>
        <section class="primary-news container-fluid py-5">
            <h2 class="primary-news-title fs-1 fw-bold pb-3">À la Une</h2>
        ...
        <aside class="container py-3">
          <h2 class="primary-section-title fs-1 fw-bold pb-3">Autre actualités</h2>
